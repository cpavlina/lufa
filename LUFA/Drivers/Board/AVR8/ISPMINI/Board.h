...
/** \file
 *  \brief Board specific information header for cpavlina's ISP MINI
 *  \copydetails Group_BoardInfo_ISPMINI
 *
 ...
 *  \defgroup Group_BoardInfo_ISPMINI ISPMINI
 *  \brief Board specific information header for cpavlina's ISP MINI
 *
 *  Board specific information header for cpavlina's ISP MINI (https://github.com/cpavlina/ispmini).
 *
 *  @{
 */

#ifndef __BOARD_ISPMINI_H__
#define __BOARD_ISPMINI_H__
